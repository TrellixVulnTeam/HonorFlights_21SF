(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('pdfjs-dist/es5/build/pdf'), require('pdfjs-dist/es5/web/pdf_viewer')) :
    typeof define === 'function' && define.amd ? define('ng2-pdf-viewer', ['@angular/core','exports', '@angular/core', 'pdfjs-dist/es5/build/pdf', 'pdfjs-dist/es5/web/pdf_viewer'], factory) :
    (global = global || self, factory(global.ng.core,global['ng2-pdf-viewer'] = {}, global.ng.core, global.PDFJS, global.PDFJSViewer));
}(this, (function (ɵngcc0,exports, core, PDFJS, PDFJSViewer) { 
...
PdfViewerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PdfViewerComponent, selectors: [["pdf-viewer"]], viewQuery: function PdfViewerComponent_Query(rf, ctx) { if (rf & 1) {
...
PdfViewerModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PdfViewerModule });
PdfViewerModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PdfViewerModule_Factory(t) { return new (t || PdfViewerModule)(); } });
